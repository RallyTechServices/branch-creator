...
If this app is on a page that is navigated to from a User Story page, then this app will automatically redirect to a Bit Bucket URL to create a new branch with 
the User Story Formatted ID and Name.  The create branch window will open in a new tab and then a grid of user stories will be displayed in the app window.
...
* http://bitbucket.mydomain.com
* bitbucket.mydomain.com (will assume an http call)
* 123.456.789.1
